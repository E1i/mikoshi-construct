...
async function main(): Promise<void> {
  ...
  console.log('costs little. It is a different transport from the ladder\'s, and that bounds what it can')
  console.log('settle: it can show how the model breaks this schema, byte by byte, and it cannot show that')
  console.log('the ladder breaks the same way. Enough to name a cause; not enough for a claim about the')
  console.log('ladder, which only scripts/bench/architect-capture.workflow.mjs can carry.')
  console.log('')
