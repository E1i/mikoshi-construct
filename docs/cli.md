...
tracked file. It writes eight files, hides them and the ledger directory through `.git/info/exclude`,
...
2. The eight carriers: `.claude/commands/plan.md`, `.claude/skills/implement/SKILL.md`,
   ...
   `scripts/construct/contract-paths.mjs` — byte-identical to what `init` writes.
...
and directories actually removed. On the eight carriers into a repository with none of their
directories, N is 14.
