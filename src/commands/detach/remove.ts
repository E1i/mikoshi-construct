...
import { removeExcludeBlock } from '../attach/exclude.js'
...
export function removeAttached(root: string, record: AttachRecord, files: string[], separator: BlockSeparator): Removal {
  ...
  removeExcludeBlock(root, separator)
