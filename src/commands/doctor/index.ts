...
export { CHECK_CLAIMS, projectKnowledge } from './projection.js'
...
export type { CheckId, CheckState, CheckVerdict, Level } from './verdict.js'
export { CHECK_IDS, LEVELS } from './verdict.js'
