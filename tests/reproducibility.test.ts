...
function presetVars(dir: string, presetId: PresetId): TemplateVars {
  ...
  return {
    ...
    ...preset.vars(detect(dir), PINNED_VARS.projectName, null),
  }
}
...
function runPinnedInit(presetId: PresetId, ai: AiTarget): string {
  ...
  writeManifest(dir, buildManifest({ version: PINNED_VARS.constructVersion, preset: presetId, ai, review: 'none', vars, written, ownedShas: {}, contracts: getPreset(presetId).contracts, previous: null, policy: null }))
